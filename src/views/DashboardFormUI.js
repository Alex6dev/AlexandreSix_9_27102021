...
import download_white from '../assets/svg/download_white.js' 
    ...
    <div class="row">
      <div class="col-sm">
        <label for="file" class="bold-label">Justificatif</label>
          ...
          ${bill.fileName===null ? (``):(`${bill.fileName.includes('pdf')? (`
          <a id="download" data-testid="icon-eye-d" href=${bill.fileUrl} target="_blank" rel="noopener"> ${download_white}</a>
          `):(`
